  ...
  const certs = [
    {
      ...
      logo: <img src="/src/assets/images/fcc-logo.png" alt="freeCodeCamp" className="w-full h-full object-contain p-1 rounded-full" />,
    ...
    },
    {
      ...
      validUntil: t('cert_valid'),
      logo: <img src="/src/assets/images/cisco-logo.png" alt="Cisco" className="w-full h-full object-contain p-1.5 rounded-full" />,
      status: t('cert_verified'),
      statusIcon: <CheckCircle2 className="w-3.5 h-3.5" />,
      statusColor: "text-gray-600 border-gray-200",
      desc: t('cert_2_desc'),
    ...
    },
    {
      ...
      validUntil: t('cert_valid'),
      logo: <img src="/src/assets/images/mongodb-logo.png" alt="MongoDB" className="w-full h-full object-contain p-1 rounded-full" />,
      status: t('cert_verified'),
      statusIcon: <CheckCircle2 className="w-3.5 h-3.5" />,
      statusColor: "text-gray-600 border-gray-200",
      desc: t('cert_3_desc'),
    ...
    },
    {
      ...
      validUntil: t('cert_valid'),
      logo: <img src="/src/assets/images/microsoft-logo.png" alt="Microsoft" className="w-full h-full object-contain p-1.5 rounded-full" />,
      status: t('cert_verified'),
      statusIcon: <CheckCircle2 className="w-3.5 h-3.5" />,
      statusColor: "text-gray-600 border-gray-200",
      desc: t('cert_4_desc'),
