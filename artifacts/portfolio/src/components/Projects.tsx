  ...
  const projects = [
    {
      ...
      dotColor: "bg-black",
      img: "/src/assets/images/streamer.png",
      logo: <FaPlay className="text-black" />,
      platforms: [
        { name: "iABS", link: "https://iabs-smm.vercel.app", logo: "/src/assets/images/iabs_logo.png" },
        { name: "TMNAA", link: "https://tmnaa.vercel.app/", logo: "/src/assets/images/tmnaa_logo.webp" },
        { name: "vilon", link: "https://vilon46.vercel.app/", logo: "/src/assets/images/vilon_logo.png" }
      ],
      alignRight: false,
      imageFirst: true,
      tools: [
    ...
    },
    {
      ...
      pillBorder: "border-black/5",
      dotColor: "bg-[#00E5A0]",
      img: "/src/assets/images/nooralislam.png",
      logo: <img src="/src/assets/images/nooralislam_logo.webp" alt="Noor Al-Islam Logo" className="w-full h-full object-contain rounded-full bg-white p-1" />,
    ...
    },
    {
      ...
      pillBorder: "border-black/5",
      dotColor: "bg-black",
      img: "/src/assets/images/dalilek.png",
      logo: <img src="/src/assets/images/dalilek_logo.png" alt="Dalilek Logo" className="w-full h-full object-contain rounded-full bg-white p-1" />,
